...
let theMenu = true;
var sideBar = document.getElementsByClassName("theSidebar3")[0];
    ...
    theMenuBtn.addEventListener('click', ()=>
    {
        ...
        else
        {
            ...
            theMenu = true;
            document.getElementsByClassName('theSidebar3')[0].style.width="0px";            
...
/*
    ...
    mediaQueryListener.addEventListener('change', event=>{
...
accnt.addEventListener('click', ()=>{
    ...
    dbC.name = "dbAccntCont";
    dbCr.name =  "dbAccntRef";
    cgButton.name ="accnt";
});
...
function subBacc()
{
    ...
    var changeDB = document.getElementById("dbChange");
    var changeTerm = document.getElementById("dbCgTerm");
    var changeRef = document.getElementById("dbCgRef");
