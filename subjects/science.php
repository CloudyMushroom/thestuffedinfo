<?php
    session_start();      
    $sciBreaks['dbSciTerm'] = $_SESSION['dbSciTerm'];
    $sciBreaks['dbScienceCont'] = $_SESSION['dbScienceCont'];
    $sciBreaks['dbSciRef'] = $_SESSION['dbSciRef'];
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $sciBreaks['dbSciTerm']; ?></strong>
                        </div>
                    </div>      
                    ...
                    <div class="row">
                        <div id="meaning" class="col">
                            <?php echo $sciBreaks['dbScienceCont']; ?>
                        </div>
                    </div>
