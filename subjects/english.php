<?php
    session_start();      
    $engBreaks['dbEngTerm'] =  $_SESSION['dbEngTerm'];
    $engBreaks['dbEnglishCont'] = $_SESSION['dbEnglishCont'];
    $engBreaks['dbEngRef'] = $_SESSION['dbEngRef'];
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $engBreaks['dbEngTerm']; ?></strong>
                        </div>
                    </div>      
                    ...
                    <div class="row">
                        <div id="meaning" class="col">
                            <?php echo $engBreaks['dbEnglishCont']; ?>
                        </div>
                    </div>
