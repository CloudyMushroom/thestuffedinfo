<?php
    session_start();      
     $PolBreaks['dbPolTerm'] = $_SESSION['dbPolTerm'];
     $PolBreaks['dbPolCont'] = $_SESSION['dbPolCont'];
     $PolBreaks['dbPolRef'] = $_SESSION['dbPolRef'];
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $PolBreaks['dbPolTerm']; ?></strong>
                        </div>
                    </div>      
