<?php
    session_start();      
    $HistBreaks['dbHistTerm'] = $_SESSION['dbHistTerm'];
    $HistBreaks['dbHistCont'] = $_SESSION['dbHistCont'];
    $HistBreaks['dbHistRef'] = $_SESSION['dbHistRef'];
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $HistBreaks['dbHistTerm']; ?></strong>
                        </div>
                    </div>      
                    ...
                    <div class="row">
                        <div id="meaning" class="col">
                            <?php echo $HistBreaks['dbHistCont']; ?>
                        </div>
                    </div>
