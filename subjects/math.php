<?php
    session_start();      
    $MathBreaks['dbMathTerm'] = $_SESSION['dbMathTerm'];
    $MathBreaks['dbMathCont'] = $_SESSION['dbMathCont'];
    $MathBreaks['dbMathRef'] = $_SESSION['dbMathRef'];
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $MathBreaks['dbMathTerm']; ?></strong>
                        </div>
                    </div>      
                    ...
                    <div class="row">
                        <div id="meaning" class="col">
                            <?php echo $MathBreaks['dbMathCont']; ?>
                        </div>
                    </div>
