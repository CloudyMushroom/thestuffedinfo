<?php
    session_start();      
     $PEBreaks['dbPETerm'] = $_SESSION['dbPETerm'];
     $PEBreaks['dbPECont'] = $_SESSION['dbPECont'];                    
     $PEBreaks['dbPERef'] = $_SESSION['dbPERef'];  
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $PEBreaks['dbPETerm']; ?></strong>
                        </div>
                    </div>      
