<?php
    session_start();      
    $TechBreaks['dbTechTerm'] = $_SESSION['dbTechTerm'];
    $TechBreaks['dbTechCont'] = $_SESSION['dbTechCont'];
    $TechBreaks['dbTechRef'] = $_SESSION['dbTechRef'];
                ...
                <form action="insDb.php" method="POST" autocomplete=off>
                    ...
                    <div class="row">
                        <div id="term" class="col">
                            <strong><?php echo $TechBreaks['dbTechTerm']; ?></strong>
                        </div>
                    </div>      
                    ...
                    <div class="row">
                        <div id="meaning" class="col">
                            <?php echo $TechBreaks['dbTechCont']; ?>
                        </div>
                    </div>
